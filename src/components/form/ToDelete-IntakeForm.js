...
import { Button, SingleSelect, SingleSelectWithAdd, ErrorMessage, Badge, Spinner } from '../common';
...
//   this.scrollView = React.createRef();
    ...
    const clear = () => {
        ...
        // TO DO: need a ref to all inputs and clear / close them as well?
    };
        ...
        <View style={{ flex: 1 }} 
            ...
            {/* Select Event Type */}
                ...
                <View onStartShouldSetResponderCapture={ () => {
                    ...
                    <SingleSelectWithAdd
                    label="LPN:"
                    // when we add a new lpn we assign it gets an id of 0 - this allows us to check it in selectedLpn later
                    items={ lpns } 
                    onAddItem={ () => handleAddLpn( lpnText ) }
                    onSelectedItemsChange={ option => handleLpnChange( 'selectedLpn', option ) }
                    selectedItems={ selectedLpn }
                    onChangeInput={ (text)=> { dispatch(actions.handleInputChange( 'lpnText', text )); props.resetSyncTime() } }
                ...
                <View onStartShouldSetResponderCapture={ () => {
                    ...
                    onChangeInput = { (text) => { dispatch(actions.handleInputChange( 'companyText', text )); props.resetSyncTime() } }
                ...
                <View onStartShouldSetResponderCapture={ () => {
                    ...
                    <SingleSelectWithAdd
                        ...
                        onChangeInput={ (text)=> { dispatch(actions.handleInputChange( 'driverText', text )); props.resetSyncTime() } }
